  ...
  _createClass(ColorInput, [{
    ...
    value: function render(_ref2) {
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          'div',
          { 'class': 'ColorInput-inputs' },
          (0, _preact.h)('input', { type: 'color', id: 'field-' + color.name, name: 'color-' + color.name, value: color.value, onChange: this.handleChange.bind(this), disabled: !this.state.override }),
          (0, _preact.h)(
            'label',
            { 'for': 'field-' + color.name, onClick: this.activateOverride.bind(this) },
            label
          ),
          (0, _preact.h)('input', { type: 'text', name: color.name, value: color.value, onChange: this.handleChange.bind(this), disabled: !this.state.override }),
          (0, _preact.h)('input', { type: 'checkbox', checked: this.state.override, onChange: this.toggleOverride.bind(this) })
        )
      );
    }
  }, {
...
},{"preact":4}],9:[function(require,module,exports) {
'use strict';
...
var _gradient = require('../lib/gradient');
...
var ColorGroup = function (_Component) {
  _inherits(ColorGroup, _Component);
  ...
  _createClass(ColorGroup, [{
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          colors.map(function (color, index) {
            return (0, _preact.h)(_ColorInput2.default, { key: color.name, onColorChange: _this2.handleColorChange.bind(_this2), onOverrideChange: _this2.handleOverrideChange.bind(_this2), index: index, color: color });
          })
        ),
        (0, _preact.h)(
          'div',
    ...
    value: function handleColorChange(color, index) {
      ...
      var lights = (0, _gradient2.default)(colors[2].value, '#ffffff', 2).hex().slice(1, 3);
      var darks = (0, _gradient2.default)(colors[2].value, '#000000', 2).hex().slice(1, 3);
      ...
      switch (changeIndex) {
        case 0:
          if (!colors[1].override) {
            var lightColors = (0, _gradient2.default)(colors[0].value, colors[2].value, 1).hex();
        ...
        case 4:
          if (!colors[3].override) {
            var darkColors = (0, _gradient2.default)(colors[2].value, colors[4].value, 1).hex();
...
},{"preact":4,"./ColorInput":8,"../lib/gradient":9}],7:[function(require,module,exports) {
"use strict";
...
var ColorGroupCss = function (_Component) {
  _inherits(ColorGroupCss, _Component);

  function ColorGroupCss() {
    _classCallCheck(this, ColorGroupCss);

    return _possibleConstructorReturn(this, (ColorGroupCss.__proto__ || Object.getPrototypeOf(ColorGroupCss)).call(this));
  }
...
exports.default = ColorGroupCss;
},{"preact":4}],3:[function(require,module,exports) {
'use strict';
...
var _ColorGroup = require('./ColorGroup');

var _ColorGroup2 = _interopRequireDefault(_ColorGroup);

var _ColorGroupCss = require('./ColorGroupCss');

var _ColorGroupCss2 = _interopRequireDefault(_ColorGroupCss);
    ...
    value: function render(props, _ref) {
      ...
      return (0, _preact.h)(
        ...
        groups.map(function (group) {
          return (0, _preact.h)(_ColorGroup2.default, { group: group, onupdate: _this2.updateGroup.bind(_this2) });
        }),
        groups.length < verbs.length && (0, _preact.h)(
          'button',
          { className: 'Button', onclick: this.addGroup.bind(this) },
          'Add group'
        ),
        (0, _preact.h)(_ColorGroupCss2.default, { groups: groups })
      );
    }
  }, {
    key: 'addGroup',
...
exports.default = App;
;
},{"preact":4,"./ColorGroup":6,"./ColorGroupCss":7}],12:[function(require,module,exports) {
var bundleURL = null;
...
},{"_css_loader":11}],1:[function(require,module,exports) {
'use strict';
...
},{"preact":4,"./components/App":3,"./sass/app.scss":2}],19:[function(require,module,exports) {
