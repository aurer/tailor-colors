  ...
  _createClass(ColorInput, [{
    ...
    value: function render(_ref, state) {
      ...
      return (0, _preact.h)(
        "div",
        null,
        (0, _preact.h)("input", { type: "color", name: color.name, value: color.value, onChange: this.handleChange.bind(this) })
      );
    }
  }, {
    key: "handleChange",
...
},{"preact":5}],8:[function(require,module,exports) {
'use strict';
...
var ColorGroup = function (_Component) {
  ...
  function ColorGroup(_ref) {
    var colors = _ref.colors;

    _classCallCheck(this, ColorGroup);

    var _this = _possibleConstructorReturn(this, (ColorGroup.__proto__ || Object.getPrototypeOf(ColorGroup)).call(this, { colors: colors }));

    _this.state = { colors: colors };
    return _this;
  }
  ...
  _createClass(ColorGroup, [{
    ...
    value: function render(props, _ref2) {
      ...
      return (0, _preact.h)(
        ...
        colors.map(function (color) {
          return (0, _preact.h)(_ColorInput2.default, { onColorChange: _this2.handleColorChange.bind(_this2), color: color });
        })
      );
    }
  }, {
    ...
    value: function handleColorChange(color) {
      var colors = this.props.colors.map(function (c) {
      ...
      var newColors = (0, _gradient2.default)(colors[0].value, colors[4].value, 3).hex();
...
},{"preact":5,"./ColorInput":7,"../lib/gradient":8}],3:[function(require,module,exports) {
'use strict';
...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.state = {
      colors: [{ name: 'color-primary-lighter', value: '#eeeeee' }, { name: 'color-primary-light', value: '#bbbbbb' }, { name: 'color-primary', value: '#888888' }, { name: 'color-primary-dark', value: '#555555' }, { name: 'color-primary-daker', value: '#222222' }]
    };
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function render(props, _ref) {
      ...
      return (0, _preact.h)(
        'div',
        null,
        (0, _preact.h)(_ColorGroup2.default, { colors: colors })
      );
    }
  }]);
...
exports.default = App;
;
},{"preact":5,"./ColorGroup":6}],2:[function(require,module,exports) {
'use strict';
...
},{"preact":5,"./components/App":3}],13:[function(require,module,exports) {
...
//# sourceMappingURL=/app.081d6020.map